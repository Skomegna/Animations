class Orc {
    constructor(game, x, y) {
        ...
        // spritesheet
        this.spritesheet = ASSET_MANAGER.getAsset("./sprites/orc_2.png");
        
        console.log(this.spritesheet);

        this.animation = new Animator(this.spritesheet, 0, 362, 68.215, 51, 12, 0.05, 0, false, true);
    ...
    draw(ctx) {
        ...
        this.animation.drawFrame(this.game.clockTick, ctx, 300, 100, 2)
